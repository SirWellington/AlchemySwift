...
class DatesPlusAlchemyTests: AlchemyTest {
    ...
    func testYearsAgo() {
        repeatTest {
            let yearsAgo = AlchemyGenerator.integer(
                fromInclusive: 0,
                toInclusive: 100
            )
            let now = Date()
    ...
    func testYearsAgoWithFutureDate() {
        repeatTest {
            let yearsAhead = AlchemyGenerator.integer(
                fromInclusive: 0,
                toInclusive: 100
            )
            let now = Date()
    ...
    func testMonthsAgo() {
        repeatTest {
            let monthsAgo = AlchemyGenerator.integer(
                fromInclusive: 0,
                toInclusive: 200
            )
            let now = Date()
    ...
    func testMonthsAgoWithFutureDate() {
        repeatTest {
            let monthsAhead = AlchemyGenerator.integer(
                fromInclusive: 0,
                toInclusive: 200
            )
            let now = Date()
